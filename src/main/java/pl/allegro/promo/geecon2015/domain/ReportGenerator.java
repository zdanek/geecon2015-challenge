...
public class ReportGenerator {
    ...
    public Report generate(ReportRequest request) {
        ...
        for (UUID userId : financialStats.getUserIds()) {
            ...
            UserTransactions usrTransactions = transactionRepository.transactionsOf(userId);

            report.add(new ReportedUser(userId, user.getName(), collect(usrTransactions.getTransactions())));
        }
        return report;
    }
